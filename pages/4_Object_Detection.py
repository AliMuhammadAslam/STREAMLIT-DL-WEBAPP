...
def object_detection_image():
    ...
    if file!= None:
        ...
        config_path = r'Yolo_Weights_Config\yolov3.cfg'
        weights_path = r'Yolo_Weights_Config\yolov3.weights'
...
def main():
    new_title = '<p style="font-size: 42px;">Welcome to the Object Detection Application!  </p>'
    read_me_0 = st.markdown(new_title, unsafe_allow_html=True)

    read_me = st.markdown(""" Select Mode to continue. """
    )
